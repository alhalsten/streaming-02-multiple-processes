...
INPUT_FILE_NAME= "Basic_Stats.csv"
report_files = [
    "Out9.txt",
]
...
def prepare_message_from_row(row):
    ...
    Age, BirthPlace, Birthday, College, CurrentStatus, CurrentTeam,Experience, Height, HighSchool, HighSchoolLocation, Name, Number, PlayerID, Position, Weight, YearsPlayed = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{Age}, {BirthPlace}, {Birthday}, {College}, {CurrentStatus}, {CurrentTeam}, {Experience}, {Height}, {HighSchool}, {HighSchoolLocation}, {Name}, {Number}, {PlayerID}, {Position}, {Weight}, {YearsPlayed}]"
...
if __name__ == "__main__":
    ...
    if not stream_row(INPUT_FILE_NAME, ADDRESS_TUPLE):
        exit(1)
